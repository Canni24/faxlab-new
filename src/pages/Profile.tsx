      ...
      <main className="container mx-auto px-4 pt-28 md:pt-32 pb-16">
        ...
        >
          ...
          <Tabs defaultValue="profile" className="w-full">
            <TabsList className="grid w-full md:w-auto grid-cols-3 mb-8 rounded-full">
              <TabsTrigger value="profile" className="flex items-center gap-2 rounded-full">
                <User className="h-4 w-4" />
                Profile
              </TabsTrigger>
              <TabsTrigger value="enrollments" className="flex items-center gap-2 rounded-full">
                  ...
                  {enrollments.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {enrollments.map((enrollment) => (
                        <div
                          key={enrollment.id}
                          className="flex flex-col md:flex-row gap-4 p-4 bg-mist rounded-2xl hover:bg-primary/5 transition-colors cursor-pointer"
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between gap-2">
                              <div>
                                ...
                                <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
                                  {enrollment.courses.level && (
                                    <Badge variant="secondary" className="rounded-full">{enrollment.courses.level}</Badge>
                                  )}
                              ...
                              {enrollment.completed && (
                                <Badge className="bg-gold text-gold-foreground rounded-full">
