...
const Checkout = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-32 pb-12 md:pt-40 md:pb-14 bg-mist">
        <div className="container mx-auto px-4 lg:px-8">
          <Button
            variant="ghost"
            className="mb-4 text-foreground/70 hover:text-primary hover:bg-primary/5"
            onClick={() => navigate(-1)}
          >
      ...
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="sticky top-28 border-0 shadow-soft rounded-[1.75rem]">
              <CardHeader>
